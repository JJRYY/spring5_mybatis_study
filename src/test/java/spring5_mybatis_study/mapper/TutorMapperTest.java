...
public class TutorMapperTest {
	...
	public void test01SelectTutorByTutorId() {
		...
		Tutor tutor = mapper.selectTutorJoinCourseByTutorId(findTutor);
	...
	public void test02InsertTutorAndDeleteTutor() {
		...
		Tutor findTutor = mapper.selectTutorJoinCourseByTutorId(tutor);
	...
	@Test
	public void test04selectTutorByTutorId() {
		log.debug(Thread.currentThread().getStackTrace()[1].getMethodName() + "()");
